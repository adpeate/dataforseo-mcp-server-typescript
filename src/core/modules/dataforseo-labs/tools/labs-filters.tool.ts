...
export class DataForSeoLabsFilterTool extends BaseTool {
  ...
  private static readonly TOOL_TO_FILTER_MAP: { [key: string]: string } = {
    'd4seolabs_google_ranked_keywords': 'ranked_keywords.google',
    'd4seolabs_google_keyword_ideas': 'keyword_ideas.google',
    'd4seolabs_google_keywords_for_site': 'keywords_for_site.google',
    'd4seolabs_google_competitors_domain': 'competitors_domain.google',
    'd4seolabs_google_serp_competitors': 'serp_competitors.google',
    'd4seolabs_google_subdomains': 'subdomains.google',
    'd4seolabs_google_domain_intersection': 'domain_intersection.google',
    'd4seolabs_google_page_intersection': 'page_intersection.google',
    'd4seolabs_google_historical_serp': 'historical_serp.google',
    'd4seolabs_google_historical_rank_overview': 'domain_rank_overview.google',
    'd4seolabs_google_relevant_pages': 'relevant_pages.google',
    'd4seolabs_google_top_searches': 'top_searches.google',
    'd4seolabs_google_keyword_overview': 'keyword_overview.google',
    'd4seolabs_google_search_intent': 'search_intent.google',
    'd4seolabs_google_bulk_keyword_difficulty': 'bulk_keyword_difficulty.google',
    'd4seolabs_google_related_keywords': 'related_keywords.google',
    'd4seolabs_google_keyword_suggestions': 'keyword_suggestions.google',
    'd4seolabs_google_domain_rank_overview': 'domain_rank_overview.google',
    'd4seolabs_google_domain_metrics_by_categories': 'domain_metrics_by_categories.google',
    'd4seolabs_google_domain_whois_overview': 'domain_whois_overview.google',
    'd4seolabs_google_categories_for_domain': 'categories_for_domain.google',
    'd4seolabs_google_keywords_for_categories': 'keywords_for_categories.google',
    ...
    'd4seolabs_google_app_competitors': 'app_competitors.google',
    'dataforseo_labs_apple_app_competitors': 'app_competitors.apple',
    'd4seolabs_google_app_intersection': 'app_intersection.google',
    'dataforseo_labs_apple_app_intersection': 'app_intersection.apple',
    'd4seolabs_google_keywords_for_app': 'keywords_for_app.google',
